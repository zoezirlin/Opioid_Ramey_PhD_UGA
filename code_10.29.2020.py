# -*- coding: utf-8 -*-
"""
Created on Sun Oct 25 13:32:25 2020
...
#AL/1
alabama_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-al-statewide-itemized.csv')
...
fip = pd.read_excel(r'C:\Users\zlz20764\Desktop\op\US_FIPS_Codes.xls', converters={'FIPS County': lambda x: str(x)})
...
#AK/2 
alaska_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ak-statewide-itemized.csv')
...
# AZ/3
arizona_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-az-statewide-itemized.csv')
...
# AR/4
arkansas_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ar-statewide-itemized.csv')
...
#CA/5
california_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ca-statewide-itemized.csv')
...
# CN/ 6
conneticut_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ct-statewide-itemized.csv')
...
#DE/7
delaware_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-de-statewide-itemized.csv')
...
#CO/9
colorado_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-co-statewide-itemized.csv')
...
#FL/10
florida_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-fl-statewide-itemized.csv')
...
#GA/11
georgia_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ga-statewide-itemized.csv')
...
#HI/12
hawaii_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-hi-statewide-itemized.csv')
...
#ID/13
idaho_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-id-statewide-itemized.csv')
...
#IL/14
illinois_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-il-statewide-itemized.csv')
...
#IN/15
indiana_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-in-statewide-itemized.csv')
...
#IA/16
iowa_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ia-statewide-itemized.csv')
...
#KS/17
kansas_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ks-statewide-itemized.csv')
...
#KY/18
kentucky_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ky-statewide-itemized.csv')
...
#LA/19
louisiana_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-la-statewide-itemized.csv')
...
#ME/20
maine_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-me-statewide-itemized.csv')
...
#MD/21
maryland_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-md-statewide-itemized.csv')
...
#MA/22
massachusetts_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ma-statewide-itemized.csv')
...
#MI/23
michigan_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-mi-statewide-itemized.csv')
...
#MN/24
minnesota_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-mn-statewide-itemized.csv')
...
#MS/25
mississippi_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ms-statewide-itemized.csv')
...
#MO/26
missouri_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-mo-statewide-itemized.csv')
...
#MT/27
montana_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-mt-statewide-itemized.csv')
...
#NE/28
nebraska_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-ne-statewide-itemized.csv')
...
#NV/29
nevada_full = pd.read_csv(
r'C:\Users\zlz20764\Desktop\op\arcos-nv-statewide-itemized.csv')
...
#NH/30
newhampshire_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-nh-statewide-itemized.csv')
...
#NJ/31
newjersey_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-nj-statewide-itemized.csv')
...
#NM/32
newmexico_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-nm-statewide-itemized.csv')
...
#NY/33
newyork_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-ny-statewide-itemized.csv')
...
#NC/34
northcarolina_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-nc-statewide-itemized.csv')
...
#ND/35
northdakota_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-nd-statewide-itemized.csv')
...
#OH/36
ohio_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-oh-statewide-itemized.csv')
...
#OK/37
oklahoma_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-ok-statewide-itemized.csv')
...
#OR/38
oregon_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-or-statewide-itemized.csv')
...
#PA/39
pennsylvania_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-pa-statewide-itemized.csv')
...
#RI/40
rhodeisland_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-ri-statewide-itemized.csv')
...
#SC/41
southcarolina_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-sc-statewide-itemized.csv')
...
#SD/42
southdakota_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-sd-statewide-itemized.csv')
...
#TN/43
tennessee_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-tn-statewide-itemized.csv')
...
#TX/44
texas_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-tx-statewide-itemized.csv')
...
#UT/45
utah_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-ut-statewide-itemized.csv')
...
#VT/46
vermont_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-vt-statewide-itemized.csv')
...
data46_A = pd.DataFrame(vermont_A.to_records())
data46_B = pd.DataFrame(vermont_B.to_records())
data46_A.fillna(0)
data46_B.fillna(0)
...
#VA/47
virginia_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-va-statewide-itemized.csv')
...
data47_A = pd.DataFrame(virginia_A.to_records())
data47_B = pd.DataFrame(virginia_B.to_records())
data47_A.fillna(0)
data47_B.fillna(0)
...
#WA/48
washington_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-wa-statewide-itemized.csv')
...
data48_A = pd.DataFrame(washington_A.to_records())
data48_B = pd.DataFrame(washington_B.to_records())
data48_A.fillna(0)
data48_B.fillna(0)
for col in data48_A.columns: 
    print(col)
data48_A.columns =['Month_Year', 
                                        'County',
                                        'Year',
                                        'Month',
                                        'State',
...
#WV/49
westvirginia_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-wv-statewide-itemized.csv')
...
westvirginia = westvirginia[westvirginia.dos_str != 'Aidarex Pharmaceuticals LLC']

westvirginia['dos_str'] = westvirginia.dos_str.astype(float)
...
#WI/50
wisconsin_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-wi-statewide-itemized.csv')
...
#WY/51
wyoming_full = pd.read_csv(r'C:\Users\zlz20764\Desktop\op\arcos-wy-statewide-itemized.csv')
...
data_A.to_csv(r'C:\Users\zlz20764\Desktop\DATA_A.csv', index = False)
...
data_B.to_csv(r'C:\Users\zlz20764\Desktop\DATA_B.csv', index = False)
...
state_values = data_A['State'].value_counts()
state_values = pd.DataFrame(data = state_values)


state_values.to_csv(r'C:\Users\zlz20764\Desktop\state_values.csv', index = False)
