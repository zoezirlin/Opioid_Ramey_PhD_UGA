...
###############################################################################
# STEP 8: creating MME_PURDUE, MME_INDUSTRY
# Total in the industry excluding purdue, by month year

# https://www.shanelynn.ie/summarising-aggregation-and-grouping-data-in-python-pandas/

# I need to collapse/ aggregate based on month_year and county and purdue_vs_industry
# group_by function

# sum is sum of values

# Sorting the dataframe by MONTH_YEAR variable
al = al.sort_values('MONTH_YEAR')


al.groupby(['BUYER_COUNTY','PURDUE_VS_INDUSTRY'])['MONTH_YEAR'].sum()





al['MME_PURDUE'] = al["Combined_Labeler_Name"] == 'Purdue Pharma LP'
